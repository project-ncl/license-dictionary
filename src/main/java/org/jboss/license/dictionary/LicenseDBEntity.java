...
public class LicenseDBEntity {
    ...
    @Getter
    @Setter
    private LicenseApprovalStatusDBEntity licenseApprovalStatus;

    @OneToMany(mappedBy = "license")
    @Getter
    @Setter
    private Set<LicenseAliasDBEntity> aliases;
    ...
    public LicenseDBEntity() {
        this.aliases = new HashSet<LicenseAliasDBEntity>();
        this.projectVersionLicenses = new HashSet<ProjectVersionLicenseDBEntity>();
    }

    public void addAlias(LicenseAliasDBEntity licenseAlias) {
