...
@ToString
@EqualsAndHashCode
public class LicenseDeterminationTypeDBEntity {
    ...
    @Getter
    @Setter
    private Set<ProjectVersionLicenseCheckDBEntity> projectVersionLicenseChecks;

    public LicenseDeterminationTypeDBEntity() {
        this.projectVersionLicenseChecks = new HashSet<ProjectVersionLicenseCheckDBEntity>();
    }

    public void addProjectVersionLicenseCheck(ProjectVersionLicenseCheckDBEntity projectVersionLicenseCheck) {
